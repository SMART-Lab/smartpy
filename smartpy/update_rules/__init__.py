from smartpy.update_rules.update_rule import UpdateRule

from smartpy.update_rules.learning_rate import LearningRate
from smartpy.update_rules.momentum import Momentum
